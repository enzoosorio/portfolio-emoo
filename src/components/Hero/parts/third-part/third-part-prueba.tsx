...
export const ThirdPart = () => {
  const [projectIsFixed, setProjectIsFixed] = useState<number>(0);
          ...
          <Translation ns={["projects_realized"]}>
            ...
            {projects_realized.map((project) => (
              ...
              {projects_realized.length > 0 && projects_realized.map((project) => (
                <div 
                key={project.project_id}
                className={`absolute bottom-16 ${projectIsFixed === project.project_id ? "left-0" : "left-full"} transition-all w-full flex items-center justify-center gap-6`}>
                  {project.project_github && (
                    ...
                    >
                      <svg width="48" height="48" viewBox="0 0 32 33" fill="none">
                  ...
                  {project.project_figma && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="rounded-full border-2 p-1 border-black"
                    >
                      <svg width="36" height="36" viewBox="0 0 48 48" fill="none" className="fill-black" >
